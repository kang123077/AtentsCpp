...
// 순차탐색
Node* DoubleSearch(Node* Head, double Target) {

}

// 전진이동법
Node* DoubleMoveToFront(Node** Head, double Target) {
...
int main( void )
{
	...
	int Length = sizeof(DataSet) / sizeof(Score);	// 배열의 요소의 갯수

	double InputValue = 0.0;
	int IsLoop = 1;

    /*  DataSet배열의 데이타 3000개를 노드에 추가 */
    for (i = 0; i < Length; i++ )
    {
